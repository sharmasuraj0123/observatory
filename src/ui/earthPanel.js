...
export class EarthPanel {
    ...
    this.el.innerHTML = `
      ...
      <div id="earth-spm-ui" class="hidden">
        <div class="spm-spec">
          ...
          <p class="spm-spec-defaults">Defaults: buoy dia <b>12 m</b> · sea depth <b>30 m</b> ·
        ...
        <div class="spm-out-cards" id="spm-out-cards">
          ...
          <div class="spm-out-card">
            <div class="spm-out-k">2. Catenary angle</div>
            <div class="spm-out-v" id="spm-out-ang">…</div>
            <div class="spm-out-note">Angle at stopper from horizontal (°)</div>
          </div>
          <div class="spm-out-card">
            <div class="spm-out-k">3. Stopper tension</div>
        ...
        Catenary angle and tension are at the surface stopper. Physics uses submerged
        chain weight (× 0.87 of air weight). <b>TAUT</b> means the span exceeds what the
        chain length allows: lengthen the chain or reduce weather loads.</p>
      </div>`;
  ...
  tick(dt) {
    ...
    sum.innerHTML = `
      <div>Real-time sim <b>t = ${sim.t.toFixed(0)} s</b> · buoy excursion <b>${exc.toFixed(2)} m</b> · heave <b>${sim.buoy.heave.toFixed(2)} m</b></div>
